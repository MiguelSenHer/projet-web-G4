...
urlpatterns = [
    ...
    path("requests/make-public/<int:collection_id>/", views.request_make_collection_public, name="request_make_collection_public"),
    path("requests/make-assembly-public/<int:assembly_id>/", views.request_make_assembly_public, name="request_make_assembly_public"),
    path("requests/make-mapping-public/<int:collection_id>/", views.request_make_mapping_collection_public, name="request_make_mapping_collection_public"),
